                ...
                <jet-modal :show="acting" closeable="true" @close="acting = null">
                    <div class="bg-gray-50 shadow-2xl p-8 v-else">
                        ...
                        <form class="flex flex-col items-center p-16" @submit.prevent="submit">
                            ...
                            <jet-input class="px-5 py-3 w-96 border border-gray-600 rounded" type="text" name="title"
                                placeholder="Project title" v-model="form.title">
                            </jet-input>

                            <jet-input-error :message="form.errors.title" />

                            <jet-input class="mt-5 px-5 py-3 w-96 border border-gray-600 rounded" type="text"
                            ...
                            <select class="w-96 border border-gray-600 rounded mt-5" v-model="form.icon_name">
